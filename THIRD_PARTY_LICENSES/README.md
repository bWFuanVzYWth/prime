...
Prime's four-wavelength realtime atmosphere is adapted from Sky Tracer under
GPL-3.0-only. See `SKY-TRACER-NOTICE.md` for the pinned source and adaptation scope.
